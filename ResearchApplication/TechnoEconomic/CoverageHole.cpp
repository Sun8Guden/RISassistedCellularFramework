...
int main(){
    ...
    double derivative_BS = Derivative::get_BS_coverage(reference_coverage_hole, coverage_threshold, test_BS_density, normalization, \
    ...
    // double derivatove_RIS = Derivative::get_RIS_derivative(reference_coverage_hole, coverage_threshold, noise_power, \
    // laplace_transform_interference, laplace_transform_reflected_signals); 
    
    std::cout << "Coverage probability is " << std::endl;
